...
public class PatientChatActivityInTherapistsPage extends AppCompatActivity {
    ...
    void setupChatRecyclerView() {
        Query query = FirebaseUtil.getChatroomMessageReference(chatroomId)
                .orderBy("timestamp", Query.Direction.DESCENDING); //this is the datasource and the chatroom id is passed and its msg are check
        ...
        adapter.startListening(); // check if there is change , a new chat , of so it adds to the view
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        if (task.isSuccessful()) {
                            messageInput.setText(""); // here I have cleared the input text
